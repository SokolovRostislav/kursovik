...
<br>
<center>
<div class="abcd" style=font-size:45px>Здесь Вы можете оставить Вашу заявку, и Мы с Вами свяжемся!</div>
	  </center>
	  <form style="    text-align: -webkit-center;" action="processorder.php" method=post>
	      <div class="tablecen">
	  <table border=0>
	  ...
	  <tr>
	  <td> Возраст Ребенка
	  <td align=left><input type="text" name="age" size=60 maxlength=20 required>
	  <tr>
	  <td> Контактный номер
	  <td align=left><input type="text" name="text" size=11 maxlength=12 required> 
	  <tr>
      <td colspan=2 align=center><input style="padding:5px; height:50px;" type=submit value="Отправить данные" >
	  </table>
	  </div>
