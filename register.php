...
<br>
<center>
<div class="abcd" style=font-size:45px>Здесь Вы можете оформить регистрацию на сайте</div>
	  </center>
	  <form style="    text-align: -webkit-center;" action="processorder1.php" method=post>
	      <div class="tablecen">
	  <table border=0>
	
	  <td width=150> <span>Ваше Имя</span>
	  <td align=left><input type="text" name="username" size=60 maxlength=30 required>
	  <tr>
	  <td> email
	  <td align=left><input type="text" name="email" size=60 maxlength=20 required>
	  <tr>
	  <td> Пароль
	  <td align=left><input type="text" style="-webkit-text-security: disc;" name="password" size=11 maxlength=12 required> 
	  <tr>
	      
      <td colspan=2 align=center><input style="padding:5px; height:50px; " input name=kuku type=submit value="Зарегистрироваться"" >
